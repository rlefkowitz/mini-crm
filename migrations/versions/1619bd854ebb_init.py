...
def upgrade() -> None:
    ...
    sa.Column('reference_table_id', sa.Integer(), nullable=True),
    sa.Column('reference_link_table_id', sa.Integer(), nullable=True),
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['enum_id'], ['enummodel.id'], ),
    sa.ForeignKeyConstraint(['reference_link_table_id'], ['linktable.id'], ),
    sa.ForeignKeyConstraint(['reference_table_id'], ['table.id'], ),
    sa.ForeignKeyConstraint(['table_id'], ['table.id'], ),
    sa.PrimaryKeyConstraint('id'),
